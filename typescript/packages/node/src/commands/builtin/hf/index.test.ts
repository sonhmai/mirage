...
const EXPECTED_NAMES = [
  'awk', 'base64', 'basename', 'cat', 'cmp', 'column', 'comm', 'csplit', 'cut',
  'diff', 'dirname', 'du', 'expand', 'file', 'find', 'fmt', 'fold', 'grep',
  'gunzip', 'gzip', 'head', 'iconv', 'join', 'jq', 'look', 'ls', 'md5',
  'mktemp', 'nl', 'paste', 'readlink', 'realpath', 'rev', 'rg', 'rm', 'sed',
  'sha256sum', 'shuf', 'sort', 'split', 'stat', 'strings', 'tac', 'tail',
  'tar', 'touch', 'tr', 'tree', 'tsort', 'unexpand', 'uniq', 'unzip', 'wc',
  'xxd', 'zcat', 'zgrep', 'zip',
]
